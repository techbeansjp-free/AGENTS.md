...
export const COMMAND_USAGE = Object.freeze([
    ...
    },
    {
        ...
        conditionalFlags: [],
        optionalFlags: [
            optional("provider", "codex", "codexだけを受理する。trusted selector採用tierと公式観測で照合し、出力はprovenance sourceがgitでusageがcodex-adoptionになる", "未指定はworking treeの既存台帳による互換検証（provenance sourceはfilesystem、usageはcompatibility-only）。認可には使わない"),
            ROOT_FLAG,
