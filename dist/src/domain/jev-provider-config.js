 ...
 */
export const JEV_PROVIDER_CONFIG_PATH = ".agent-skill-chain/local/jev-provider.json";
 ...
 */
export function loadJevProviderConfig(root, configPath = JEV_PROVIDER_CONFIG_PATH) {
 ...
 * 外部から見た挙動は変えない。
 */
export function classifyJevProviderConfig(root, configPath = JEV_PROVIDER_CONFIG_PATH) {
    ...
    const record = parsed;
    const unknownKeys = Object.keys(record).filter((key) => !ALLOWED_FIELDS.has(key));
...
//# sourceMappingURL=jev-provider-config.js.map