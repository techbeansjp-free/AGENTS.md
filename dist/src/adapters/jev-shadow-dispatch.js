...
import { buildJevShadowRecord, isJevShadowEligible, planJevShadowQuestion, } from "../domain/jev-shadow.js";
import { appendJevShadowRecord, findJevShadowRecord, } from "./jev-shadow-store.js";
export async function runJevContinuousShadow(input) {
    if (!isJevShadowEligible(input.result.executor))
        return {
            ran: false,
            reason: "対象decision typeではありません（executor.kindがproviderではない）",
        };
...
//# sourceMappingURL=jev-shadow-dispatch.js.map