...
|---|---|---|---|---|---|---|---|
| （6 roleのいずれか） | （project choiceのrole contract） | （証拠ID・参照先） | routine / standard / advanced / critical | （provider上限） | （tier mapping） | （安全な停止点・再開条件） | （implementerとreviewerのidentity・context比較） |
