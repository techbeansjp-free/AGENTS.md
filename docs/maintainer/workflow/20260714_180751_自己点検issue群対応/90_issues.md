...
- **完了**: 9 / 35（バッチ1・7並列 worktree が全て mainへマージ済み。統合により実働 7 worktree、issue 単位では 9 件: 163129, 163252, 163531, 163629, 163756, 163913, 163931, 164009, 164245 / PR #50, #51, #52, #53, #54, #55, #57）
- **進行中**: 0 / 35
- **未着手**: 24 / 35（却下 2 件・完了 9 件を除く残り）
...
- **高優先度**: 3 / 8（163129, 163203, 163305, 163502, 163531, 163833, 164009, 及び統合先を含む。完了: 163129, 163531, 164009）
- **中優先度**: 3 / 16（完了: 163629, 163913, 163252）
- **低優先度**: 3 / 9（完了: 163756, 163931, 164245）
- **却下（優先度なし）**: 0 / 2
