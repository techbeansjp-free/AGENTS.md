...
**全バッチ完了（2026-07-14〜07-15実施）**: 「対応する」28 件すべてが main へマージ済み。
...
- **完了**: 28 / 35（バッチ1・7並列＋バッチ2・4並列＋バッチ3・4並列＋バッチ4・3並列＋バッチ5・1並列＋バッチ6・1並列＋バッチ7・1 worktree が全て mainへマージ済み。統合により実働 21 worktree、issue 単位では 28 件: 163129, 163203, 163206, 163252, 163305, 163330, 163403, 163432, 163447, 163502, 163531, 163600, 163629, 163640, 163717, 163724, 163756, 163810, 163833, 163852, 163913, 163931, 164009, 164034, 164050, 164128, 164206, 164245 / PR #50, #51, #52, #53, #54, #55, #57, #60, #61, #63, #64, #66, #67, #69, #70, #72, #74, #76, #81, #84, #86）
- **進行中**: 0 / 35
- **未着手**: 5 / 35（却下 2 件・完了 28 件を除く残り。残る 5 件はすべて様子見）
...
- **中優先度**: 14 / 16（完了: 163206, 163252, 163330, 163403, 163432, 163600, 163629, 163640, 163724, 163852, 163913, 164034, 164050, 164128）
