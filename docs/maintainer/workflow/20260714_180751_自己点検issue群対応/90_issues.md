...
- **完了**: 13 / 35（バッチ1・7並列＋バッチ2・4並列 worktree が全て mainへマージ済み。統合により実働 11 worktree、issue 単位では 13 件: 163129, 163252, 163305, 163531, 163600, 163629, 163756, 163810, 163913, 163931, 164009, 164206, 164245 / PR #50, #51, #52, #53, #54, #55, #57, #60, #61, #63, #64）
- **進行中**: 0 / 35
- **未着手**: 20 / 35（却下 2 件・完了 13 件を除く残り）
...
- **高優先度**: 4 / 8（163129, 163203, 163305, 163502, 163531, 163833, 164009, 及び統合先を含む。完了: 163129, 163305, 163531, 164009）
- **中優先度**: 4 / 16（完了: 163252, 163600, 163629, 163913）
- **低優先度**: 5 / 9（完了: 163756, 163810, 163931, 164206, 164245）
- **却下（優先度なし）**: 0 / 2
