...
- **完了**: 22 / 35（バッチ1・7並列＋バッチ2・4並列＋バッチ3・4並列＋バッチ4・3並列 worktree が全て mainへマージ済み。統合により実働 18 worktree、issue 単位では 22 件: 163129, 163203, 163252, 163305, 163447, 163502, 163531, 163600, 163629, 163717, 163724, 163756, 163810, 163833, 163852, 163913, 163931, 164009, 164034, 164128, 164206, 164245 / PR #50, #51, #52, #53, #54, #55, #57, #60, #61, #63, #64, #66, #67, #69, #70, #72, #74, #76）
- **進行中**: 0 / 35
- **未着手**: 11 / 35（却下 2 件・完了 22 件を除く残り）
...
- **中優先度**: 8 / 16（完了: 163252, 163600, 163629, 163724, 163852, 163913, 164034, 164128）
