...
- .workflow/templates/01_要件定義.md または親 issue の 01（形式参照）。
...
- 行数・見出し構成は .workflow/templates/01_要件定義.md または親 issue の 01 に合わせる。workflow/TEMPLATES.md を参照。
...
- CONCEPTS、RULES。PHASES。.workflow/templates または親 01_要件定義.md。
