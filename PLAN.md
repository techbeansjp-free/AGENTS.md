...
| 6 | workflow templateと展開結果、ADR、role contractを同期 | AC-1, AC-2, AC-7 |
| 7 | 攻撃経路・互換性・回帰テストと独立検証を実施 | 全AC |
...
- 攻撃: PR変更verifier/allowlistの不使用、branch内偽証跡、未登録actor、writer actor投稿、dismissed review、API commit ID不一致、古いSHA、prompt/artifact改変、slot重複、Strict 1件。
