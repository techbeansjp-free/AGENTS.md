...
| 4 | テンプレート正本 ci.yml への同期 | `.agent-skill-chain/templates/github/.github/workflows/agent-skill-chain-ci.yml` へ #1・#2 と**同一**の変更を反映（verify-template-sync ステップには変更を加えない）（設計要素D） | AC-4 | #1, #2 |
